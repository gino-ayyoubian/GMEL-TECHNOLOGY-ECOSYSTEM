...
const PatentNode: React.FC<{ patent: Patent }> = ({ patent }) => {
    ...
    const hasTechPage = ['GMEL-CLG', 'GMEL-DrillX', 'GMEL-ThermoFluid', 'GMEL-EHS', 'GMEL-NanoStab'].includes(patent.code);
        ...
        <div className="relative flex flex-col items-center gap-12 py-8 min-w-[1024px]">
            <svg className="absolute top-0 left-0 w-full h-full z-0" aria-hidden="true" preserveAspectRatio="none">
                <defs>
                 ...
                 {/* Core -> Derivatives */}
                <path d="M 50% 120 L 12.5% 220" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="1.5" className="connector-line" style={{animationDelay: '0.1s'}} />
                <path d="M 50% 120 L 37.5% 220" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="1.5" className="connector-line" style={{animationDelay: '0.2s'}} />
                <path d="M 50% 120 L 62.5% 220" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="1.5" className="connector-line" style={{animationDelay: '0.3s'}} />
                <path d="M 50% 120 L 87.5% 220" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="1.5" className="connector-line" style={{animationDelay: '0.4s'}} />
                {/* Inter-Derivatives Connections */}
                <path d="M 12.5% 300 C 20% 340, 30% 340, 37.5% 300" stroke="rgba(30, 159, 217, 0.4)" strokeWidth="1.5" strokeDasharray="4 4" className="connector-line" style={{animationDelay: '0.5s'}} title="EHS controls DrillX" />
                <path d="M 12.5% 300 C 45% 350, 80% 350, 87.5% 300" stroke="rgba(30, 159, 217, 0.4)" strokeWidth="1.5" strokeDasharray="4 4" className="connector-line" style={{animationDelay: '0.6s'}} title="EHS controls NanoStab" />
                <path d="M 62.5% 300 C 70% 340, 80% 340, 87.5% 300" stroke="rgba(30, 159, 217, 0.4)" strokeWidth="1.5" strokeDasharray="4 4" className="connector-line" style={{animationDelay: '0.7s'}} title="NanoStab stabilizes ThermoFluid" />

                {/* Derivatives -> Applied */}
                <path d="M 50% 390 L 50% 480" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="2" markerEnd="url(#arrow)" className="connector-line" style={{animationDelay: '0.8s'}} />
                
                {/* Applied -> Strategic */}
                <path d="M 50% 660 L 50% 750" stroke="rgba(71, 85, 105, 0.7)" strokeWidth="2" markerEnd="url(#arrow)" className="connector-line" style={{animationDelay: '1s'}} />
            </svg>
