...
export const capex_vs_revenue_title = "CAPEX vs. Annual Revenue (5MW Pilot)";
...
export const financial_summary_title = "AI-Generated Financial Summary";
export const financial_summary_description = "Click the button to generate a narrative summary and analysis of the project's financial data using Gemini. This provides an executive-level overview of the project's financial viability.";
export const financial_summary_prompt = "Based on the following financial data for a 5MW pilot plant, provide a concise narrative summary (2-3 paragraphs) suitable for an executive briefing. Analyze the data, focusing on the key metrics like CAPEX, annual revenue, payback period, and ROI. Conclude with an assessment of the project's financial viability.\n\nData:\n- Pilot CAPEX (5MW): 575 Billion Toman\n- Annual Revenue (5MW): 390 Billion Toman\n- Payback Period: 2 Years\n- Return on Investment (ROI): 42 Percent\n- 10-Year NPV: 2750 Billion Toman";
...
export const nda_body = `I, the undersigned, registered in the KKM system as the 'Signer', undertake to keep all information, documents, data, codes, and any non-public material related to the GMEL project confidential, and shall not disclose, publish, or exploit them without the written permission of Kimia Karan Mad company or its legal representative. The confidentiality obligation period is ten years from the date of termination of collaboration. In the event of any unauthorized disclosure or use, I undertake to pay a penalty of five billion Tomans (5,000,000,000 IRR) and accept legal and criminal proceedings. The company reserves the right to suspend or revoke access and claim damages exceeding the penalty amount. This agreement is valid and enforceable from the date of electronic signature. The electronic signature, recorded with a JSON evidence package including the signer's ID, document hash, UTC time, IP address, KYC and liveness result, and evidence registration transaction ID, is considered a written signature and is admissible in judicial authorities.`;
...
export const tech_comparison_prompt = `
    ...
    - Levelized Cost of Energy (LCOE) ($/MWh)
    - Operational & Maintenance (O&M) Costs ($/MWh)
    - Estimated CAPEX/MW (or relevant unit)
    - Parasitic Load (%)
    - Average Construction Time (Months)
    - Physical Footprint (m²/MW)
    - Technology Readiness Level (TRL)
    - Environmental Impact
`;
export const simulations_title = "Simulations & Modeling";
export const simulations_description = "Utilize AI-driven models to generate ideal project packages from the GMEL patent portfolio or envision 'blue sky' concepts for future innovation based on the selected region.";
export const gmel_modeler_title = "Ideal GMEL Project Modeler";
export const gmel_modeler_description = "Based on the selected region, generate an optimized project package using the existing GMEL patent portfolio to maximize profitability and productivity.";
export const generate_gmel_package = "Generate Ideal GMEL Package";
export const generating_gmel_package = "Generating GMEL Package...";
export const recommended_patents = "Recommended Patent Package";
export const package_synergies = "Synergistic Application Strategy";
export const primary_value_prop = "Primary Value Proposition";
export const estimated_profitability = "Estimated Profitability Analysis";
export const gmel_package_prompt = `As a senior project strategist for KKM, devise the optimal GMEL project package for the {region}. Your response must be a single JSON object. The JSON should contain keys: "recommendedPatents" (an array of patent code strings from the GMEL portfolio that are most suitable for the region), "synergies" (a string explaining how these patents work together), "primaryValueProposition" (a string summarizing the main benefit for the region), and "estimatedProfitability" (a string providing a qualitative assessment like 'High' or 'Very High' with a brief justification). Base your decisions on the known characteristics of the selected region and the applications of the GMEL patents.`;

export const visionary_engine_title = "Visionary Project Proposal Engine";
export const visionary_engine_description = "Leveraging global research and foresight, this generates a 'blue sky' project concept for the region, unconstrained by the current GMEL framework, to inspire future innovation.";
export const generate_visionary_proposal = "Generate Visionary Proposal";
export const generating_visionary_proposal = "Researching & Generating Visionary Proposal...";
export const visionary_proposal_for = "Visionary Proposal: {region}";
export const core_concept = "Core Concept";
export const enabling_tech = "Key Enabling Technologies";
export const transformative_impact = "Transformative Impact";
export const new_patent_opportunities = "New Patent Opportunities";
export const visionary_proposal_prompt = `Act as a futurist and international energy consultant. Use your search capabilities to research the latest global tech trends (AI, materials science, robotics, biotech) and the specific current economic and strategic needs of {region}. Formulate a novel, ambitious, 'blue sky' project proposal that integrates geothermal energy in a way not covered by the standard GMEL patents. Your response MUST be a single JSON object within your text. The JSON object should have the keys: "proposalTitle" (a creative name for the project), "coreConcept" (a detailed paragraph explaining the visionary idea), "enablingTechnologies" (an array of strings listing cutting-edge technologies required), "potentialImpact" (a paragraph on the transformative impact), and "newPatentIdeas" (an array of strings suggesting new patent concepts KKM could pursue).`;
...
export const regional_analysis_prompt = "Provide a current (2024-2025) and detailed analysis of the {region}. Focus on its geopolitical situation, economic needs (specifically regarding energy, water, and strategic minerals), existing infrastructure, and potential for foreign investment. Use Google Search to ensure the information is up-to-date and grounded.";
export const proposal_generation_prompt = `
    ...
    Inject the following content for the "regional_analysis" section:
    ---
...
export const gmel_statement_title = "Statement from the Inventor, Seyed Gino Ayyoubian";
export const gmel_statement_body = `The GeoMeta Energy Layer (GMEL) is not merely an invention; it is the culmination of years of research, a vision for a sustainable future, and a testament to the power of integrating diverse scientific disciplines. Born from a deep understanding of thermodynamics, geology, and advanced materials, GMEL represents a paradigm shift in how we perceive and harness geothermal energy. Our core philosophy is to create a closed-loop, self-sustaining ecosystem that is not only environmentally benign but also economically transformative. By eliminating the need for environmentally disruptive practices like fracking and moving beyond the limitations of traditional geothermal systems, GMEL opens up vast, untapped energy resources in low-gradient thermal zones previously considered unviable. This technology is designed to be a catalyst for regional development, offering a sovereign solution for energy, water, and strategic resources. The patent portfolio surrounding GMEL is a strategic fortress, designed to protect this vision and ensure its responsible deployment. We are not just building power plants; we are engineering the foundation for resilient, self-sufficient communities and a cleaner planet for generations to come. This project is a commitment to innovation, sovereignty, and the relentless pursuit of a better future.`;
export const infrastructure_sidebar_title = "Infrastructure Navigator";
export const filter_by_type = "Filter by Type";
export const filter_by_proximity = "Filter by Proximity (km)";
export const all_types = "All Types";
export const heatmap_legend_title = "Geothermal Gradient";
export const legend_low = "Low";
...
export const market_analysis_description = "Click the button to generate an up-to-date market analysis using Google Search. This provides a grounded, executive-level overview of the market conditions, competition, and regulatory landscape in the selected region.";
export const welcome_title = "Welcome to the GeoMeta Energy Layer Vision";
...
export const two_factor_prompt = "A verification code has been sent to +98912... and g.ayyoubian@kkm-intl.org. Please enter the code to continue.";
export const verification_code_placeholder = "Enter verification code";
export const verify_button = "Verify";
export const two_factor_error = "Invalid verification code. Please try again.";
...
export const opex_modifier = "CAPEX / OpEx Modifier";
export const calculated_roi = "Calculated ROI";
export const calculated_payback = "Calculated Payback Period";
export const ipo_analysis_title = "IPO Projection Analysis";
