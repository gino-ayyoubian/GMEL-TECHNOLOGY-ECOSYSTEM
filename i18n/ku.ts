...
export const revenue_streams_prompt = "شیکاری سەرچاوەکانی داهات بۆ وێستگەی GMEL لە {region} (داهاتی ساڵانە: {revenue}). دابەشی بکە بۆ: کارەبا، ئاو، هایدرۆجین، لیتیۆم. JSON بگەڕێنەوە لەگەڵ 'table' و 'narrative'. زمان: {language}.";
export const revenue_streams_title = "سەرچاوەکانی داهات";
export const revenue_streams_desc = "وردەکاری داهات لە کارەبا، ئاو، هایدرۆجین و لیتیۆم.";
export const generate_revenue_breakdown = "بەرهەمهێنانی دابەشکاری داهات";
export const revenue_stream_chart_title = "پێکهاتەی داهات";
...
export const compare_financials_title = "بەراوردکاری دارایی ڕاستەوخۆ";
export const select_region_to_compare = "دیاریکردنی ناوچە بۆ بەراوردکردن";
export const financial_metric_capex = "خەرجی سەرمایەی پایلۆت (٥ مێگاوات)";
export const financial_metric_revenue = "داهاتی ساڵانە (٥ مێگاوات)";
export const financial_metric_payback = "ماوەی گەڕانەوە";
export const financial_metric_roi = "ڕێژەی گەڕانەوەی وەبەرهێنان (ROI)";
export const financial_metric_npv = "بەهای ئێستای پوخت بۆ ١٠ ساڵ (NPV)";
