...
export const PATENT_PORTFOLIO: Patent[] = [
  { level: 'Derivatives', code: 'GMEL-EHS', title: 'Quantum Sensor & Control System', application: 'Self-powered quantum sensors and ML for 99.5% accurate real-time monitoring and predictive control.', status: 'In design', path: 'National registration by end of 1404' },
  { level: 'Derivatives', code: 'GMEL-DrillX', title: 'Autonomous Smart Drilling', application: 'Smart drilling with autonomous robots, reducing drilling time by 50% and optimizing heat exchange paths.', status: 'In design', path: 'Concurrent with EHS' },
  { level: 'Derivatives', code: 'GMEL-ThermoFluid', title: 'Nanocomposite Thermal Fluid', application: 'Proprietary nanocomposite fluid increasing heat transfer efficiency by over 35%.', status: 'Confidential', path: 'Proprietary formula registration' },
  { level: 'Derivatives', code: 'GMEL-ORC Compact', title: 'High-Efficiency Portable Converter', application: 'Compact Organic Rankine Cycle turbine with 25% efficiency for portable low-temperature power generation.', status: 'In design', path: '1405' },
  { level: 'Applied', code: 'GMEL-Desal', title: 'Low-Energy Desalination Module', application: 'Low-energy desalination (GOR >10) integrated with Direct Air Capture (DAC) for carbon-neutral water production.', status: 'Qeshm Pilot', path: 'National registration 1405' },
  { level: 'Applied', code: 'GMEL-H₂Cell', title: 'Geothermal Hydrogen Production', application: 'Green hydrogen production via thermal electrolysis, achieving 60% efficiency and costs under $1/kg.', status: 'Lab validated', path: '1405–1406' },
  { level: 'Applied', code: 'GMEL-AgriCell', title: 'AI-Controlled Agri-System', application: 'AI-controlled sustainable greenhouse using geothermal heat, achieving a 6x increase in yield.', status: 'Studies in progress', path: '1405' },
  { level: 'Applied', code: 'GMEL-LithiumLoop', title: 'Advanced Direct Lithium Extraction', application: 'Advanced DLE with 92% yield using selective membranes for extraction from geothermal brine.', status: 'Lab validated', path: '1406' },
  { level: 'Applied', code: 'GMEL-EFuels', title: 'E-Fuel Synthesis Module', application: 'Produces electronic fuels (e-fuels) via H₂/CO₂ synthesis with 70% efficiency, creating a new revenue stream.', status: 'In design', path: '1406' },
  { level: 'Strategic', code: 'GMEL-EcoCluster', title: 'Sustainable Economic Cluster Model', application: 'Sustainable economic model for energy-centric rural development, generating up to 150 jobs/MW.', status: 'In development', path: 'Management model registration 1405' },
  { level: 'Strategic', code: 'GMEL-GeoCredit', title: 'Blockchain Carbon Credit System', application: 'Blockchain-based platform for transparent carbon credit financing and trading.', status: 'Software design phase', path: '1406' },
  { level: 'Strategic', code: 'GMEL-SmartGrid', title: 'AI-Powered Smart Grid', application: 'Intelligent grid with ML-based load forecasting, reducing energy loss by up to 40%.', status: 'In design', path: '1406' },
];
