...
export const CORE_PATENT: Patent = {
  level: 'Core',
  code: 'GMEL-CLG',
  title: 'Advanced Closed-Loop Geothermal System',
...
export const PATENT_PORTFOLIO: Patent[] = [
  { level: 'Derivatives', code: 'GMEL-EHS', title: 'Quantum Sensor & Control System', application: 'Self-powered quantum sensors and ML for 99.5% accurate real-time monitoring and predictive control.', status: 'In design', path: 'National registration by end of 1404', kpi: '99.5% accurate real-time monitoring', progress: 25 },
  { level: 'Derivatives', code: 'GMEL-DrillX', title: 'Autonomous Smart Drilling', application: 'Smart drilling with autonomous robots, reducing drilling time by 50% and optimizing heat exchange paths.', status: 'In design', path: 'Concurrent with EHS', kpi: 'Reduces drilling time by 50%', progress: 25 },
  { level: 'Derivatives', code: 'GMEL-ThermoFluid', title: 'Nanocomposite Thermal Fluid', application: 'Proprietary nanocomposite fluid increasing heat transfer efficiency by over 35%.', status: 'Confidential', path: 'Proprietary formula registration', kpi: 'Increases heat transfer efficiency by over 35%', progress: 80 },
  { level: 'Derivatives', code: 'GMEL-ORC Compact', title: 'High-Efficiency Portable Converter', application: 'Compact Organic Rankine Cycle turbine with 25% efficiency for portable low-temperature power generation.', status: 'In design', path: '1405', kpi: '25% efficiency for portable power generation', progress: 25 },
  { level: 'Applied', code: 'GMEL-Desal', title: 'Low-Energy Desalination Module', application: 'Low-energy desalination (GOR >10) integrated with Direct Air Capture (DAC) for carbon-neutral water production.', status: 'Qeshm Pilot', path: 'National registration 1405', kpi: 'Low-energy desalination (GOR > 10)', progress: 60 },
  { level: 'Applied', code: 'GMEL-H₂Cell', title: 'Geothermal Hydrogen Production', application: 'Green hydrogen production via thermal electrolysis, achieving 60% efficiency and costs under $1/kg.', status: 'Lab validated', path: '1405–1406', kpi: '60% efficiency, costs under $1/kg', progress: 50 },
  { level: 'Applied', code: 'GMEL-AgriCell', title: 'AI-Controlled Agri-System', application: 'AI-controlled sustainable greenhouse using geothermal heat, achieving a 6x increase in yield.', status: 'Studies in progress', path: '1405', kpi: '6x increase in yield', progress: 40 },
  { level: 'Applied', code: 'GMEL-LithiumLoop', title: 'Advanced Direct Lithium Extraction', application: 'Advanced DLE with 92% yield using selective membranes for extraction from geothermal brine.', status: 'Lab validated', path: '1406', kpi: '92% yield with selective membranes', progress: 50 },
  { level: 'Applied', code: 'GMEL-EFuels', title: 'E-Fuel Synthesis Module', application: 'Produces electronic fuels (e-fuels) via H₂/CO₂ synthesis with 70% efficiency, creating a new revenue stream.', status: 'In design', path: '1406', kpi: '70% efficiency in H₂/CO₂ synthesis', progress: 25 },
  { level: 'Strategic', code: 'GMEL-EcoCluster', title: 'Sustainable Economic Cluster Model', application: 'Sustainable economic model for energy-centric rural development, generating up to 150 jobs/MW.', status: 'In development', path: 'Management model registration 1405', kpi: 'Generates up to 150 jobs/MW', progress: 30 },
  { level: 'Strategic', code: 'GMEL-GeoCredit', title: 'Blockchain Carbon Credit System', application: 'Blockchain-based platform for transparent carbon credit financing and trading.', status: 'Software design phase', path: '1406', kpi: 'Blockchain-based financing & trading', progress: 20 },
  { level: 'Strategic', code: 'GMEL-SmartGrid', title: 'AI-Powered Smart Grid', application: 'Intelligent grid with ML-based load forecasting, reducing energy loss by up to 40%.', status: 'In design', path: '1406', kpi: 'Reduces energy loss by up to 40%', progress: 25 },
];
...
export const getProjectSummaryPrompt = (region: Region): string => {
  ...
  return `
    ...
    - Strategic Alignment: Connect the project with national policies (5000 MW renewable target by 2030) and the specific development goals of the ${region}, focusing on sustainable development, job creation (200 jobs), and technology leadership.
