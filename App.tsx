...
import { AppContext, AppContextProvider, AppContextType } from './contexts/AppContext';
...
export const LanguageSwitcher = () => {
    const { lang, setLang, supportedLangs } = useContext(AppContext) as AppContextType;
...
const AuthScreen = () => {
  const { authStep } = useContext(AppContext) as AppContextType;
...
const MainAppLayout = () => {
    const { activeView, setActiveView, region, setRegion, currentUser, userRole, setCurrentUser, setUserRole, setAuthStep, allowedRegions, lang, sessionToken, setSessionToken, setAllowedRegions, setError } = useContext(AppContext) as AppContextType;
    const { t } = useI18n();
